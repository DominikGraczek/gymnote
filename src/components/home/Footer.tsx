...
export const Footer = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 md:static md:w-48 md:h-full bg-purple-100 flex md:flex-col justify-around md:justify-start items-center md:items-start px-4 py-3 md:py-6 md:gap-6 text-black shadow-lg z-50">
